...
def evaluate_model(test_set, model_name= 'NeighbourNER_model', metric_type = 'accuracy'):
    model = AutoModelForSequenceClassification.from_pretrained(model_name, id2label={0: 'non-NER', 1: 'org', 2: "misc", 3: "loc", 4: "per"} )
    training_args = TrainingArguments(output_dir="test_trainer", evaluation_strategy="epoch")
...
eval_valid = evaluate_model(valid_dataset, 'NeighbourNER_experiment3_valid', 'accuracy')
print(eval_valid)
eval_valid = evaluate_model(valid_dataset, 'NeighbourNER_experiment3_valid', 'f1')
print(eval_valid)
eval_valid = evaluate_model(valid_dataset, 'NeighbourNER_experiment3_valid', 'precision')
print(eval_valid)
eval_valid = evaluate_model(valid_dataset, 'NeighbourNER_experiment3_valid', 'recall')
print(eval_valid)
print("test dataset 2")
eval_test = evaluate_model(test_dataset, 'NeighbourNER_experiment3_valid', 'accuracy')
print(eval_test)
eval_test = evaluate_model(test_dataset, 'NeighbourNER_experiment3_valid', 'f1')
print(eval_test)
eval_test = evaluate_model(test_dataset, 'NeighbourNER_experiment3_valid', 'precision')
print(eval_test)
eval_test = evaluate_model(test_dataset, 'NeighbourNER_experiment3_valid', 'recall')
print(eval_test)
