...
def get_dataset(data, dataClassLimit):
  ...
  masked_training_data_positive_B = get_NER_masked_postive_data(data, masked_count, "B", 1)
  masked_training_data_pos_B_joined = convert_list_to_sentence(masked_training_data_positive_B)
  masked_training_data_pos_B_joined = masked_training_data_pos_B_joined[0:dataClassLimit]
  ...
  print(data[3])
  print("class 1")
  print(masked_training_data_pos_B_joined[0])
  print(masked_training_data_pos_B_joined[1])
  print(masked_training_data_pos_B_joined[2])
  print(masked_training_data_pos_B_joined[3])
  print(masked_training_data_pos_B_joined[4])
  print(masked_training_data_pos_B_joined[5])
  print(masked_training_data_pos_B_joined[6])
  print(masked_training_data_pos_B_joined[7])
  # print(len(masked_training_data_pos_B_joined))

  masked_training_data_pos, masked_count = get_NER_position_positive_data(data)
  masked_training_data_positive_I = get_NER_masked_postive_data(data, masked_count, "I", 2)
  masked_training_data_pos_I_joined = convert_list_to_sentence(masked_training_data_positive_I)
  masked_training_data_pos_I_joined = masked_training_data_pos_I_joined[0:dataClassLimit]

  print("class 2")
  # print(len(masked_training_data_pos_I_joined))
  print(masked_training_data_pos_I_joined[0])
  print(masked_training_data_pos_I_joined[1])
  ...
  masked_data_df = pd.DataFrame(masked_training_data_pos_B_joined + masked_training_data_pos_I_joined + masked_training_data_neg_joined, columns=['text', 'label'])
...
small_test_data.to_csv('data/experiment2_test_data.csv', sep='\t')
small_training_data.to_csv('data/experiment2_training_data.csv', sep='\t')
small_valid_data.to_csv('data/experiment2_valid_data.csv', sep='\t')
